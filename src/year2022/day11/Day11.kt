...
fun playMonkeyInTheMiddle(monkeysById: Map<Int, Monkey>, rounds: Int, divideWorryLevel: Int = 1): Long {
...
fun parseMonkeysById(input: List<String>) = (input + "").chunked(7).map { lines ->
